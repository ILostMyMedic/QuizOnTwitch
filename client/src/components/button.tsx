...
const styles = {
    base: [
        ...
        // Focus
        'focus:outline-none data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-primary',
    ...
    plain: [
        ...
        'dark:text-white dark:data-[active]:bg-zinc-700 dark:data-[hover]:bg-zinc-700',
    ...
    colors: {
        ...
        primary: [
            'text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.primary)] [--btn-border:theme(colors.primary/90%)]',
